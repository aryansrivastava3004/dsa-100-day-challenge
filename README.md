...
Over the next 100 days, I will be consistently learning and practicing Data Structures & Algorithms (DSA) using Python while documenting my progress publicly.

## Goals

- Build a consistent coding habit
- Strengthen problem-solving skills
- Learn DSA systematically
